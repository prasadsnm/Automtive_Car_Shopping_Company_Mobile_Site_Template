		  	...
		  	$.getJSON(url, function(data){
		  		...
		  		$.each(data, function(index, item){
		  			if(($.inArray(item.make, makeArray)) == -1){
		  			   ...
		  			   parent.append('<li data-icon="list-arrow"> <a data-transition="slidedown" href="inquire_form.php"><img src="images/car_logo/' + (item.make).toLowerCase() + '.png" class="ui-li-thumb"/>' + item.make + '</a></li>');
